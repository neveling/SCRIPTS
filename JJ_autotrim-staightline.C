...
//
{
  ...
  //Int_t run_no[]={1047,1048,1050,1051};  
  Int_t run_no[]={1050,1048};  
  ...
  Int_t xnumbins,xminbin=3000,xmaxbin=7000;	// Plot range for zoomed histo
...
//*******************************************************
      for(Int_t r=0;r<nrofruns;r++) {
          //sprintf(namerun,"~/DATA/ROOT/PR251/autotrim-run0%d.root",run_no[r]);
          sprintf(namerun,"~/DATA/ROOT/PR260/sorted0%d.root",run_no[r]);
